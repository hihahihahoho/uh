    ...
    void 0 !== e && e.bindingHandlers && !e.bindingHandlers.multiselect && (e.bindingHandlers.multiselect = {
        ...
        defaults: {
            ...
            templates: {
                ...
                ul: '<ul class="multiselect-container dropdown-menu"><ul class="multiselect-inner isolated-scroll"></ul></ul>',
        ...
        createOptionValue: function(e) {
            ...
            var s = this.options.optionLabel(e),
                ...
                p = t("label", a);
            p.addClass(n), p.attr("title", s), a.addClass(l), this.options.collapseOptGroupsByDefault && "optgroup" === t(e).parent().prop("tagName").toLowerCase() && (a.addClass("multiselect-collapsible-hidden"), a.hide()), this.options.enableHTML ? p.html(" ") : p.text(" "), p.prepend('<span class="' + n + "-ic no-animation " + n + "-sm " + n + '-style-1"></span><span class="' + n + '-text">' + s + "</span>");
            var h = t("<input/>").attr("type", n).addClass("hidden"),
                c = this.options.checkboxName(i);
            c && h.attr("name", c), p.prepend(h);
            var r = i.prop("selected") || !1;
            h.val(o), o === this.options.selectAllValue && (a.addClass("multiselect-item multiselect-all"), h.parent().parent().addClass("multiselect-all")), p.attr("title", i.attr("title")), this.$ul.find(".multiselect-inner").append(a), i.is(":disabled") && h.attr("disabled", "disabled").prop("disabled", !0).closest("a").attr("tabindex", "-1").closest("li").addClass("disabled"), h.prop("checked", r), r && this.options.selectedClass && h.closest("li").addClass(this.options.selectedClass)
        },
        ...
        createOptgroup: function(e) {
            var i = t(e).attr("label"),
                s = t(e).attr("value"),
                l = t('<li class="multiselect-item multiselect-group"><a href="javascript:void(0);"><label class="checkbox"><b></b></label></a></li>'),
                o = this.options.optionClass(e);
            l.addClass(o), this.options.enableHTML ? t("label", l).append('<span class="checkbox-ic no-animation checkbox-sm"></span><span class="checkbox-text">'+ i +'</span>') : t("label", l).append('<span class="checkbox-ic no-animation checkbox-sm"></span><span class="checkbox-text">'+ i +'</span>'), this.options.enableCollapsibleOptGroups && this.options.multiple && t("a", l).append('<span class="caret-container"><b class="caret"></b></span>'), this.options.enableClickableOptGroups && this.options.multiple && t("a label", l).prepend('<input class="hidden" type="checkbox" value="' + s + '"/>'), t(e).is(":disabled") && l.addClass("disabled"), this.$ul.find(".multiselect-inner").append(l), t("option", e).each(t.proxy(function(t, e) {
        ...
        buildSelectAll: function() {
            if ("number" == typeof this.options.selectAllValue && (this.options.selectAllValue = this.options.selectAllValue.toString()), !this.hasSelectAll() && this.options.includeSelectAllOption && this.options.multiple && t("option", this.$select).length > this.options.includeSelectAllIfMoreThan) {
                ...
                t("label", e).addClass("checkbox"), this.options.enableHTML ? t("label", e).append('<span class="checkbox-ic no-animation checkbox-sm"></span><span class="checkbox-text">'+ this.options.selectAllText +'</span>') : t("label", e).append('<span class="checkbox-ic no-animation checkbox-sm"></span><span class="checkbox-text">'+ this.options.selectAllText +'</span>'), this.options.selectAllName ? t("label", e).prepend('<input class="hidden" type="checkbox" name="' + this.options.selectAllName + '" />') : t("label", e).prepend('<input type="checkbox" class="hidden"/>');
                var i = t("input", e);
                ...
                if (this.$select.find("option").length >= e) {
                    ...
                    this.$ul.prepend(this.$filter), this.$filter.val(this.query).on("click", function(t) {
                        ...
                        13 === e.which && e.preventDefault(), clearTimeout(this.searchTimeout), this.searchTimeout = this.asyncFunction(t.proxy(function() {
                            ...
                            }, this))), this.updateSelectAll(), this.options.enableClickableOptGroups && this.options.multiple && this.updateOptGroups(), this.options.onFiltering(e.target)
                        }, this), 300, this)
                    }, this))
                }
            }
